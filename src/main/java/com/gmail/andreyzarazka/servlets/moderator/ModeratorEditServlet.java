...
import com.gmail.andreyzarazka.servlets.AdminEditServlet;
...
public class ModeratorEditServlet extends HttpServlet {
    private static Logger log = Logger.getLogger(ModeratorEditServlet.class.getName());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.sendRedirect("/moderator-panel");
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("pages/moderatorEdit.jsp").forward(request, response);
    }
